...
export default function AILabsPage() {
  return (
    <div className="relative min-h-screen pt-28 px-6 md:px-16 text-white overflow-hidden">
      ...
      bg-teal-500 opacity-20 blur-[150px] rounded-full"></div>

      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] 
      bg-green-500 opacity-20 blur-[150px] rounded-full"></div>
        ...
        >
          ...
          <div className="p-10">
            ...
            <p className="text-gray-300 mb-6">
              ...
              the right schools and programs for both undergraduate and postgraduate 
              (Master’s) studies.
            </p>
      ...
      <div className="grid md:grid-cols-2 gap-16 mt-28 items-center">
        ...
        >
          <Image
            src="/images/ab1.png"   // 🔥 replace with your image
            alt="Collaboration"
            width={600}
            height={500}
        ...
        <div>
          ...
          <div className="space-y-5">
            ...
            <input
              ...
              focus:shadow-[0_0_15px_rgba(45,212,191,0.3)]
              transition-all duration-300"
            />
            ...
            <button className="px-8 py-3 rounded-full border border-teal-400 
            text-white hover:bg-teal-500 hover:text-black
