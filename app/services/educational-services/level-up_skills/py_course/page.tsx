  ...
  const topics = [
    {
      ...
      content: [
        "Python Fundamentals (Variables, Data Types, Loops)",
  ...
  return (
    <div className="relative min-h-screen pt-28 text-white overflow-hidden px-6 md:px-16">
      ...
      <h1 className="text-4xl md:text-5xl font-bold mb-16 text-center">
        Python Programming <span className="text-teal-400">Course</span>
      </h1>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-gray-300">
              Build a strong foundation in Python programming and understand how
          ...
          >
            ...
            <p className="text-gray-300">
              Work on real-world projects including automation scripts, data
              analysis tasks, and mini applications.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300">
              Gain practical skills used in software development, data science,
