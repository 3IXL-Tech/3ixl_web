  ...
  return (
    <div className="relative min-h-screen pt-28 text-white overflow-hidden px-6 md:px-16">
      ...
      <h1 className="text-4xl md:text-5xl font-bold mb-16 text-center">
        Machine Learning <span className="text-teal-400">Course</span>
      </h1>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-gray-300">
              Learn how to build predictive models and intelligent systems using
              real-world datasets and modern machine learning techniques.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300">
              Work on real-world machine learning projects, from data preprocessing
          ...
          >
            ...
            <p className="text-gray-300">
              Gain in-demand skills used in AI, data science, and advanced analytics
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          >
            ...
            <ul className="space-y-4 text-gray-300 mb-8">
              <li>• Pay 25% of the course fee upfront</li>
            ...
            text-white hover:bg-teal-500 hover:text-black transition duration-300" onClick={() => window.open("https://paystack.shop/pay/o9jhc5by5l", "_blank")}>
              Enroll Now
            </button>
          </motion.div>
          ...
          >
            ...
            <h4> Price: <b>GH₵400.00</b></h4>
            <button className="px-6 py-3 rounded-full border border-teal-400 
            text-white hover:bg-teal-500 hover:text-black transition duration-300" onClick={() => window.open("https://paystack.shop/pay/exm00nwq6o", "_blank")}>
              Enroll Now
            </button>
          </motion.div>
